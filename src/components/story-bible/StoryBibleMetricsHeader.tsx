...
type StoryBibleMetricsHeaderProps = {
...
export function StoryBibleMetricsHeader({
  scores,
  storyTitle,
  themes,
  tone,
}: StoryBibleMetricsHeaderProps) {
  const subtitle = [themes, tone].filter(Boolean).join(" · ");
      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="text-right">
          <p className="text-[10px] font-medium uppercase tracking-wide text-[var(--brand-text-secondary)]">
            {CREATOR_STORY_METRICS.consistencyScore}
          </p>
          <p

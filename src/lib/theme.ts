...
export const DEFAULT_THEME: ThemeId = "sunset-dark";

/** Resolve theme from saved preference; defaults to dark for new users. */
...
export const THEME_INIT_SCRIPT = `(function(){try{var k=${JSON.stringify(THEME_STORAGE_KEY)};var s=localStorage.getItem(k);var t=(s==="sunset-light"||s==="sunset-dark")?s:"sunset-dark";document.documentElement.setAttribute("data-theme",t);}catch(e){document.documentElement.setAttribute("data-theme","sunset-dark");}})();`;
